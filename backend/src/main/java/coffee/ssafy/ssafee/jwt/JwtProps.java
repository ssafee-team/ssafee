...
public class JwtProps {
    ...
    public JwtProps(String accessSecretKeyBase64, @DurationUnit(ChronoUnit.SECONDS) Duration accessExpirationSeconds,
                    String refreshSecretKeyBase64, @DurationUnit(ChronoUnit.SECONDS) Duration refreshExpirationSeconds) {
