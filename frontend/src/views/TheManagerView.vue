		...
		<header>
			...
			<div style="margin-right: auto; font-size: 8px; transform: translateY(-8px);">
				...
				<div class="shop-name" :class="{ isfold: isFold }" @click="toggleShop">{{ shopname }} {{ tri }}
					<div v-if="isFold">
						<div @click="goEditor" class="edit-info"><hr>기본정보 수정</div>
		...
		<body>		
			<div class="body-container">
				<div v-if="isOrderTime && !isRejected" class="black-bg">
					<div class="white-bg">
						<div style="font-size: 30px; font-weight: bold;">🔔 알림 🔔</div>
						<div>
						...
						<div class="button-container">
							<input @click="acceptOrder" class="button accept" :class="{cliked : isAccepted }" type="button" value="주문접수">
							<input @click="rejectOrder" class="button reject" :class="{cliked : isRejected}" type="button" value="주문거절">
						</div>
					</div>
				</div>
