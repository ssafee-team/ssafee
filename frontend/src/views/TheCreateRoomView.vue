...
<div class="modal-wrap" v-show="modalCheck">
  ...
  <div class="child">
   ...
   height="150px">
    ...
    <br>
    <img v-on:click="addPlatform('백다방')" src="../assets/img/coffeebrand/백다방커피.jpg" alt="" 
     :class="{ 'border1': true, 'grayscale': !isBaekSelected }"  width="150px" height="150px">
  </div>
