<template>
  <div class="menulist">
      ...
      <div class="white-bg">
        ...
        <div class="modal-title">
          <div>
            {{
              isInit
                ? this.orders[selectedStudentNo].studentName
                : this.ordersCopied[selectedStudentNo].studentName
            }}
            님의 주문내역
          </div>
          <div>
            ...
            <div style="width: 75%">
              ...
              <div class="options">
                ...
                <div v-if="selectedOrder.menuOptions.length <= 2">
                  <div style="padding: 4px">기본옵션</div>
                </div>
              </div>
            </div>
    ...
    <div style="z-index: 1" class="menulistbox">
      ...
      <div v-if="!isSortedByMenu" class="orderbox" style="font-size: 32px">
        <div
          ...
          :class="{
            ...
            isCarrier: this.carriersArr.includes(order.studentName) ? true : false,
          }"
        >
          ...
          <div
            v-if="
              this.carriersArr.includes(order.studentName) &&
              this.payers.includes(order.studentName)
            "
            class="studentname"
          >
            {{ order.studentName }}🛵💰
      ...
      <div v-if="isSortedByMenu" class="orderbox" style="font-size: 32px">
        <div class="ordermenu2" v-for="(order, index) in ordersMenuSorted" :key="index">
          <div class="classno">{{ order.classNo }}</div>
